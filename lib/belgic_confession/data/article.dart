class Article {
  ...
  Article({this.index, this.title, this.content});

  static final List<Article> items = [
    Article(
      index: 1,
      title: "Article 1: The Only God",
      content:
          "We all believe in our hearts and confess with our mouths that there is a single and simple spiritual being, whom we call God -- eternal, incomprehensible, invisible, unchangeable, infinite, almighty; completely wise, just, and good, and the overflowing source of all good.",
    ),
    Article(
      index: 2,
      title: "Article 2: The Means by Which We Know God",
      content:
          "We know him by two means:\n\nFirst, by the creation, preservation, and government of the universe, since that universe is before our eyes like a beautiful book in which all creatures, great and small, are as letters to make us ponder the invisible things of God: his eternal power and his divinity, as the apostle Paul says in Romans 1:20.\n\nAll these things are enough to convict men and to leave them without excuse.\n\nSecond, he makes himself known to us more openly by his holy and divine Word, as much as we need in this life, for his glory and for the salvation of his own.",
    ),
    Article(
      index: 3,
      title: "Article 3: The Written Word of God",
      content:
    ...
    Article(
      index: 4,
      title: "Article 4: The Canonical Books",
      content:
    ...
    Article(
      index: 5,
      title: "Article 5: The Authority of Scripture",
      content:
    ...
    Article(
      index: 6,
      title: "Article 6: The Difference Between Canonical and Apocryphal Books",
      content:
    ...
    Article(
      index: 7,
      title: "Article 7: The Sufficiency of Scripture",
      content:
